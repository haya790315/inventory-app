...
public class ItemRecordController extends BaseController {
  ...
  @DeleteMapping("/{id}")
  public ResponseEntity<Object> deleteItemRecord(@PathVariable("id") UUID id) {
    itemRecordService.deleteItemRecord(id);
    return response(HttpStatus.ACCEPTED, "ItemRecord deleted");
  }
}
