...
public class CategoryController extends BaseController {
  ...
  @ApiResponses({
      @ApiResponse(responseCode = "202", description = "カスタムカテゴリの削除が完了しました", content = @Content(mediaType = "application/json", examples = @ExampleObject(value = "{ \"message\": \"カスタムカテゴリの削除が完了しました\" }"))),
